...
![image-20211213114409327](https://gitee.com/sheep101/typora-img-save/raw/master/img/image-20211213114409327.png)
...
![image-20211213114153154](https://gitee.com/sheep101/typora-img-save/raw/master/img/image-20211213114153154.png)
...
export function bulidURL(url: string, params?: any) {
  ...
  Object.keys(params).forEach((key) => {
    ...
    if (Array.isArray(val)) {
      values = val
      key += '[]' // http://localhost:9090/base/get?foo[]=bar,baz
    } else {
      values = [val]
    }
    values.forEach((val) => {
