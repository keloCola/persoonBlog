---
title: 获取响应数据
date: 2021-12-15 11:20:30
permalink: /pages/a80136/
categories:
  - 体系课程
  - ts-axios
tags:
...
![image-20211213145022563](https://gitee.com/sheep101/typora-img-save/raw/master/img/image-20211213145022563.png)

## 需求分析

在前面的章节中，我们发送的请求都可以从网络层面接收到服务端返回的数据，但是`代码层面`并没有做任何关于返回数据的处理。我们希望能`处理服务端响应的数据，并支持 Promise 链式调用`的方式，如下：
